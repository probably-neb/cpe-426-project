...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {pw1_bb0[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pw1_bb0[0]}]
#set_property PACKAGE_PIN V16 [get_ports {pw1_bb0[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pw1_bb0[1]}]
#set_property PACKAGE_PIN W16 [get_ports {pw2_bb0[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pw2_bb0[0]}]
#set_property PACKAGE_PIN W17 [get_ports {pw2_bb0[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pw2_bb0[1]}]
#set_property PACKAGE_PIN W15 [get_ports {pw1_bb1[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pw1_bb1[0]}]
#set_property PACKAGE_PIN V15 [get_ports {pw1_bb1[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pw1_bb1[1]}]
#set_property PACKAGE_PIN W14 [get_ports {pw2_bb1[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pw2_bb1[0]}]
#set_property PACKAGE_PIN W13 [get_ports {pw2_bb1[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {pw2_bb1[1]}]
#set_property PACKAGE_PIN V2 [get_ports {bit_in}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {bit_in}]
#set_property PACKAGE_PIN T3 [get_ports {f0}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {f0}]
#set_property PACKAGE_PIN T2 [get_ports {f1}]					
...
set_property PACKAGE_PIN R2 [get_ports {send}]					
...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {out_buffer}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {out_buffer}]
##Sch name = JB2
...
##Sch name = XA4_P
#set_property PACKAGE_PIN N2 [get_ports {uwb_out}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {uwb_out}]
##Sch name = XA1_N
set_property PACKAGE_PIN K3 [get_ports {uwb_out}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {uwb_out}]
##Sch name = XA2_N
